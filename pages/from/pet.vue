<template>
	<view class="content">
		<uni-forms ref='form' :rules="globalData.rules">
			...
			<view class="form">
				<uni-forms-item class="itemx" labelWidth="60" label="宠物种类" name="petKind">
					<uni-easyinput class="input" :inputBorder="false" type="text" v-model="formdata.petKind" placeholder="请输入宠物种类" placeholder-style="color:#878787"/>
				</uni-forms-item>
				<uni-forms-item class="itemx" labelWidth="60" label="宠物年龄" name="petAge">
					<uni-easyinput class="input" :inputBorder="false" type="digit" v-model="formdata.petAge" placeholder="请输入宠物年龄" placeholder-style="color:#878787"/>
				</uni-forms-item>
				<view class="item flexd flex-center">
					<view class="label">疫苗</view>
					<radio-group class="gender flexd jubetween">
						<label class="uni-list-cell uni-list-cell-pd flexd flex-center" @click="formdata.vaccinated=1">
							<view class="m-0">
								<radio :checked="formdata.vaccinated==1"/>
							</view>
							<view class="m-0">是</view>
						</label>
						<label class="uni-list-cell uni-list-cell-pd flexd flex-center" @click="formdata.vaccinated=0">
							<view class="m-0">
								<radio :checked="formdata.vaccinated==0"/>
							</view>
							<view class="m-0">否</view>
						</label>
					</radio-group>
				</view>
				<uni-forms-item class="itemx" labelWidth="60" label="出售价格" name="sellingPrice">
					<uni-easyinput class="input" :inputBorder="false" type="digit" v-model="formdata.sellingPrice" placeholder="请输入出售价格" placeholder-style="color:#878787"/>
				</uni-forms-item>
				<view class="item">
					<view class="flexd">
				...
				<view class="item" v-if="cateList.length&&cateList[cateIndex].id==2">
					<view class="flexd">
						...
						<picker :value="shopIndex" :range="shopList" range-key="operation_point_name" @change="bindPickerChange2">
							<view class="uni-input">{{shopList[shopIndex]?shopList[shopIndex].operation_point_name: '1'}}</view>
						</picker>
					</view>
				</view>
			</view>
			...
			<view class="form">
				<view class="item">
					<view style="font-size: 24rpx;margin-bottom: 10rpx;">请上传宠物图片</view>
					<view class="out">
