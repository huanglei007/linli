<template>
	<view class="content">
		...
		<view class="order">
			<view class="bgBox">
				<view class="input">
					<input type="text" v-model="formdata.talentName" placeholder="请输入达人名称"
						placeholder-style="color: #8b8b8b;font-size: 30rpx;" />
				</view>
				<view class="input">
					<input type="number" step='1' placeholder="请输入联系方式"
						placeholder-style="color: #8b8b8b;font-size: 30rpx;" maxlength="11"
						@input="inputchange($event, 'talentPhone')" />
				</view>
				<!-- <view class="input"> -->
				...
				<view class="input">
					<picker :value="operationIndex" :range="operation" range-key="operation_point_name"
						...
						<view class="uni-input">
							{{operation[operationIndex]?operation[operationIndex].operation_point_name:''}}</view>
					</picker>
				</view>
				<!-- <view class="input">
				...
				<view class="input">
					<picker :value="shopIndex" :range="shopTpye" range-key="service_type_name"
				...
				<view class="zhengjian">
					...
					<view class="flexd">
						<view class="item">
							<view class="imageBox">
								<image @click="formdata.idcardFront=''" v-if="formdata.idcardFront"
									:src="Img(formdata.idcardFront)" mode=""></image>
								<image @click="onimg('idcardFront')" v-if="!formdata.idcardFront"
									src="/static/image/img_sfz_z.png" mode=""></image>
							</view>
							<view class="sub">
								请上传身份证正面
							</view>
						...
						<view class="item">
							<view class="imageBox">
								<image @click="formdata.idcardFront=''" v-if="formdata.idcardBack"
									:src="Img(formdata.idcardBack)" mode=""></image>
								<image @click="onimg('idcardBack')" v-if="!formdata.idcardBack"
									src="/static/image/img_sfz_f.png" mode=""></image>
							</view>
							<view class="sub">
								请上传身份证反面
							</view>
