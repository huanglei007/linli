		...
		<view class="operation flexd jucenter flex-center">
			<view class="flexd jubetween flex-center">
				<view class="searchBox flexd jucenter flex-center">
					...
					<input class="input" type="text" v-model="searchParam" placeholder="请输入达人名称" placeholder-style="font-size:24rpx;color:#888"/>
				</view>
			...
			<view class="item flexd" v-for="(item,index) in shopList" :key="index" @click="$jump('/pages/index/darenDetail?id='+item.id)">
				...
				<view class="message">
					...
					<view class="flexd jubetween flex-center">
						...
						<view class="taketo" @click="$jump('/pages/chat/HM-chat?idse='+id)">
