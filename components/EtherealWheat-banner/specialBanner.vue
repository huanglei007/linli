<template>
  <div class="banner-container">
    <swiper :style="{width: '100vw', height: '330rpx'}" 
    ...
    <div class="desc-wrap" v-if="bannerList[descIndex].title||bannerList[descIndex].description" :class="[isDescAnimating?'hideAndShowDesc':'']">
